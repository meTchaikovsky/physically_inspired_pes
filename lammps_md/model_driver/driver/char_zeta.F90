...
integer :: num_atomic_types = 7
! 'Li', 'N', 'P', 'S', 'Cl', 'Ge', 'Br'
integer, dimension(7) :: atomic_numbers = (/3, 7, 15, 16, 17, 32, 35/)

double precision, dimension(7) :: &
atomic_radii = (/1.67d0, 0.56d0, 0.98d0, 0.88d0, 0.79d0, 1.25d0, 0.94d0/)
double precision, dimension(7) :: &
ionic_radii = (/1.45d0, 0.65d0, 1.00d0, 1.00d0, 1.00d0, 1.25d0, 1.15d0/)
double precision, dimension(7) :: &
covalent_radii = (/1.34d0, 0.75d0, 1.06d0, 1.02d0, 0.99d0, 1.22d0, 1.14d0/)
double precision, dimension(7) :: &
vdw_radii = (/1.82d0, 1.55d0, 1.80d0, 1.80d0, 1.75d0, 1.86d0, 1.85d0/)
double precision, dimension(7) :: &
crystal_radii = (/0.90d0, 0.30d0, 0.31d0, 0.43d0, 1.67d0, 0.53d0, 1.82d0/)
