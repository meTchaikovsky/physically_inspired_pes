...
from compare.f_calc import char_zeta
...
def calc(
    ...
    for des in des_fp:
        ...
        if des_type == 'g3_angle':
            gamma, zeta, des_company, etas = des[1:]
            piles.append(
...
def calculate_g2_prime(
    ...
    ridge = np.zeros((3, len(etas))).astype(np.float64)
